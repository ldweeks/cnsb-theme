...
<article class="node-<?php print $node->nid; ?> <?php print $classes; ?> clearfix ds-2col-fluid"<?php print $attributes; ?>>
  ...
  <div class="group-left">
    <?php
      ...
      hide($content['field_bandcamp']);
      hide($content['field_sellfy']);
      hide($content['field_powerpoint']);
      hide($content['field_chart']);
      hide($content['field_lead_sheet']);
      hide($content['field_sheet_music']);
      hide($content['field_album']);
